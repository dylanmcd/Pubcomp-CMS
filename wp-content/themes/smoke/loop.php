...
<?php endif; ?>
			...
			<?php if ( function_exists( 'get_post_format' ) && 'gallery' == get_post_format( $post->ID ) ) : ?>
				<a href="<?php echo get_post_format_link( 'gallery' ); ?>" title="<?php esc_attr_e( 'View Galleries', '' ); ?>"><?php _e( 'More Galleries', '' ); ?></a>
				<span class="meta-sep">|</span>
			<?php elseif ( in_category( _x( 'gallery', 'gallery category slug', '' ) ) ) : ?>
...
<?php /* How to display posts of the Aside format. The asides category is the old way. */ ?>
	...
	<?php elseif ( ( function_exists( 'get_post_format' ) && 'aside' == get_post_format( $post->ID ) ) || in_category( _x( 'asides', 'asides category slug', '' ) )  ) : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
