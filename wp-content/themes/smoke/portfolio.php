  ...
  <div class="grid_16"> 
    <div id="ps_slider" class="ps_slider" style="margin-top:32px;">
      ...
      <div id="ps_albums">
		  ...
		  <?php 
          $category = get_option_tree('picture_slide_categories');
          $number = get_option_tree('picture_slide_show');
          ?>         
          <?php if (have_posts()) : ?>
...
<div class="container_16">
  <div class="grid_16" id="social-back">
    <div class="grid_10 social-area">
      <h1 style="margin-left:-60px;"><?php get_option_tree( 'picture_portfoliotitle', '', 'true' ); ?></h1>
      <p style="margin-left:-61px;"><?php get_option_tree( 'picture_portfoliosubtitle', '', 'true' ); ?></p>
    </div>
...
<div class="container_16">
  <div class="grid_16" style="width:970px;">
    <a href="#" class="switch_thumb">Switch Thumb</a> 
      ...
      <ul class="display">
	  <?php 
          $category = get_option_tree('picture_portfoliocategories');
          $number = get_option_tree('picture_portfolioshow');
          ?>         
      ...
      <li>
        <div class="content_block">
          <a href="<?php echo get_post_meta($post->ID, "thumb", $single = true); ?>" rel="lightbox" title="<?php the_title_limit( 30, '...'); ?>::<?php content('10'); ?>" class="an7_thumb"><img src="<?php bloginfo('template_directory'); ?>/scripts/timthumb.php?src=<?php echo get_post_meta($post->ID, "thumb", $single = true); ?>&amp;h=100&amp;w=146" alt="" /></a>
          <h2><a href="<?php the_permalink() ?>"><?php the_title_limit( 30, '...'); ?></a></h2>
          <p><?php content('10'); ?></p>
          <div class="mini-button-portfolio"><a href="<?php the_permalink() ?>" class="mini-red" style="margin-right:4px;">more</a> <a href="<?php echo get_post_meta($post->ID, "thumb", $single = true); ?>" rel="lightbox" title="<?php the_title_limit( 30, '...'); ?>::<?php content('10'); ?>" class="an7_thumb mini-yellow">look</a></div>
          <div style="clear:both;"></div>
        </div>
      </li>
