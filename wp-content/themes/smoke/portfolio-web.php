<?php /** Template Name: Portfolio Web */ get_header(); ?>
  ...
  <div class="grid_16"> 
    <div id="ps_slider" class="ps_slider" style="margin-top:32px;">
      ...
      <div id="ps_albums">
		  ...
		  <?php 
          $category = get_option_tree('web_slide_categories');
          $number = get_option_tree('web_slide_show');
          ?>         
          <?php if (have_posts()) : ?>
...
<div class="container_16">
  <div class="grid_16" id="social-back">
    <div class="grid_10 social-area">
      <h1 style="margin-left:-60px;"><?php get_option_tree( 'web_portfoliotitle', '', 'true' ); ?></h1>
      <p style="margin-left:-61px;"><?php get_option_tree( 'web_portfoliosubtitle', '', 'true' ); ?></p>
    </div>
...
<div class="container_16">
  <div class="grid_16" style="width:970px;">
    <a href="#" class="switch_thumb">Switch Thumb</a> 
      ...
      <ul class="display">
	  <?php 
          $category = get_option_tree('web_portfoliocategories');
          $number = get_option_tree('web_portfolioshow');
          ?>         
      ...
      <li>
        <div class="content_block">
          ...
          <p><?php content('10'); ?></p>
          <div class="mini-button-portfolio"><a href="<?php the_permalink() ?>" class="mini-red" style="margin-right:4px;">more</a> <?php if ( get_post_meta($post->ID, 'web', true) ) { ?><a href="<?php echo get_post_meta($post->ID, "web", $single = true); ?>" rel="lightbox[external 80% 660]" title="<?php the_title_limit( 30, '...'); ?>" class="an7_thumb mini-yellow">web</a><?php } ?> </div>
          <div style="clear:both;"></div>
        </div>
      </li>
